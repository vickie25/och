...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            self.stdout.write('\nUser Breakdown:')
            self.stdout.write('  - Admins: 2 (admin1@test.com - admin2@test.com)')
            self.stdout.write('  - Directors: 3 (director1@test.com - director3@test.com)')
            self.stdout.write('  - Mentors: 5 (mentor1@test.com - mentor5@test.com)')
            self.stdout.write('  - Students: 40 (student1@test.com - student40@test.com)')
            self.stdout.write('  - Finance Admins: 1 (finance1@test.com)')

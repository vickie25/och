...
def main():
    ...
    if user_created:
        print("✅ Created sponsor user: sponsor@test.com")
    else:
        print("✅ Sponsor user already exists: sponsor@test.com")
        # Ensure account is active
        sponsor_user.account_status = 'active'
        sponsor_user.email_verified = True
        sponsor_user.save()
        print("✅ Updated sponsor user to active status")
    ...
    if role_assigned:
        print("✅ Assigned sponsor_admin role to user")
    ...
    if member_created:
        print("✅ Added user to organization as admin")

    # Set user's org_id
    sponsor_user.org_id = org
    sponsor_user.save()

    print("✅ Set user's org_id to organization")

    print("\n" + "=" * 60)
    print("✅ Setup Complete!")
    print("=" * 60)
    print("\nLogin credentials:")
    print("  Email: sponsor@test.com")

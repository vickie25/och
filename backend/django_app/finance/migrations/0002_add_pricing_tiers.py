# Generated manually due to migration issues
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_per_unit', models.DecimalField(decimal_places=2, help_text='Price per unit per month in selected currency', max_digits=10)),
                ...
                ('annual_discount_percent', models.DecimalField(decimal_places=2, default=Decimal('0'), help_text='Discount percentage for annual billing', max_digits=5)),

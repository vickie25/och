...
class DynamicPricingService:
    ...
    @classmethod
    def get_institution_rate(cls, student_count: int, currency: str = 'USD') -> Decimal | None:
    ...
    @classmethod
    def get_employer_rate(cls, plan: str, currency: str = 'USD') -> Decimal | None:
    ...
    @classmethod
    def calculate_institution_invoice(cls, contract, billing_cycle: str = 'monthly') -> Decimal | None:
    ...
    @classmethod
    def calculate_employer_invoice(cls, contract) -> Decimal | None:

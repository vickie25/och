                  ...
                  <div className="mt-3">
                    ...
                    <div className="space-y-1">
                      {role.missions.slice(0, 3).map(mission => (
                        <Link
                          key={mission.id}
                          href={`/mentor/dashboard/missions/${mission.id}`}
                ...
                {frameworkData[selectedFramework].map((item: any, index: number) => (
                  ...
                  >
                    <div className="flex items-start justify-between">
                      ...
                      <Link href={`/mentor/dashboard/missions/${item.missionId}`}>
                    ...
                    <div className="mt-2">
                      <Link
                        href={`/mentor/dashboard/missions/${item.missionId}`}
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start justify-between mb-3">
                        ...
                        <Link href={`/mentor/dashboard/missions/${mission.id}`}>
                          <Button variant="defender" size="sm">
                            View Details
                          </Button>
                        </Link>

  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold">SLA Compliance Monitor</h2>
          <p className="text-gray-600">Service level agreement performance tracking</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card>
          <CardContent className="p-6">
            ...
            <Progress value={slaData.overallCompliance * 100} className="mt-3" />
          </CardContent>
        </Card>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Contract SLA Performance</CardTitle>
        </CardHeader>
        <CardContent>
      ...
      {slaData.alerts.length > 0 && (
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              {slaData.alerts.slice(0, 5).map((alert) => (
                <div key={alert.id} className="flex items-start justify-between p-4 border rounded-lg">
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      {alert.daysSincePosted} days overdue
                    </p>
                  </div>
                </div>
              ))}

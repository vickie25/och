...
import { InstitutionCommercialTermsPrintDocument } from '@/components/institution/InstitutionCommercialTermsPrintDocument'
import { Printer } from 'lucide-react'

export default function InstitutionCommercialTermsPage() {
  return (
    <div className="min-h-screen bg-och-midnight print:bg-white print:p-8">
      <div className="max-w-3xl mx-auto p-6 print:max-w-none print:p-0">
        <div className="mb-6 flex flex-wrap items-center justify-between gap-3 print:hidden">
          <Link href="/dashboard/institution/contracts" className="text-sm font-medium text-och-mint hover:underline">
            ← Contracts
          </Link>
          <button
            type="button"
        ...
        <InstitutionCommercialTermsPrintDocument />
      </div>
    </div>
  )
}

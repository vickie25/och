...
export default function EmployerInvoiceDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-och-midnight p-6">
      <div className="max-w-5xl mx-auto space-y-6">
        <div>
          <Link href="/dashboard/employer/contracts/invoices" className="text-sm font-medium text-och-mint hover:underline">
            ← Invoices
          </Link>
            ...
            <Card className="p-5 border border-och-steel/20">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                ...
                <div>
                  ...
                  {invoice.contract_id ? (
                    <Link className="text-och-mint hover:underline" href={`/dashboard/employer/contracts/${invoice.contract_id}/complete`}>
                      View full contract
                    </Link>
                  ) : (

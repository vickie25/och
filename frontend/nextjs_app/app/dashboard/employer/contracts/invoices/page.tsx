            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-och-steel/15">
                {loading ? (
                  ...
                  <tr>
                    <td colSpan={9} className="py-10 px-4 text-center text-och-steel">
                      No invoices yet. They appear here once Finance generates billing for your contract.
                    </td>
                  </tr>
                ) : (
                  rows.map((inv) => (
                    <tr key={inv.id} className="hover:bg-och-steel/10">
                      ...
                      <td className="py-3 px-4 text-och-steel">
                        {inv.contract_id ? (
                          <Link className="text-och-mint hover:underline" href={`/dashboard/employer/contracts/${inv.contract_id}/complete`}>
                            View contract
                          </Link>
                        ) : (
                          '—'
                      ...
                      <td className="py-3 px-4 text-och-steel">
                        <Link className="text-och-mint hover:underline" href={`/dashboard/employer/contracts/invoices/${inv.id}`}>
                          Details
                        </Link>
                      </td>
                    </tr>

...
# Master Deployment Script - Run this on your DigitalOcean server
...
echo "App running at: http://ongozacyberhub.com"
echo ""
echo "To setup SSL, run:"
echo "cd $HOME/ongozacyberhub && ./deploy/setup-ssl.sh ongozacyberhub.com"
